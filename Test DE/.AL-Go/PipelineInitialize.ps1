...
$adminUsername = "admin"
$info = fkh createcontainer --name $containerName --artifactUrl $artifact --adminUsername $adminUsername --adminPassword $adminPassword --useOIDC --asJson | ConvertFrom-Json
$bcAuthContext = @{
